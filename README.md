...
## How to Run (LTS Guide)

**See the presentation slides that are on your OneDrive. There everything is detailed**

The rest of this document comes from the original repository.
...
### If you don't have pip or git (Original Repo)
